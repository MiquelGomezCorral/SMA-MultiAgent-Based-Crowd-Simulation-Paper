...
Por ejemplo, se pueden re hacer los experimentos mencionados anteriormente pero con la opción de \textit{reaparición de agentes} activada. Luego, tras una cantidad decente te steps, el flujo se estabiliza y se pueden recoger métricas como la densidad media, velocidad media y ritmo de evacuación. 
...
Aprovechamos esta funcionalidad para crear una interfaz interactiva donde se pueden ajustar parámetros como la densidad de agentes, la proporción de tipos de agentes y las características del entorno antes de iniciar la simulación.

Además, para hacer visibles los agentes, colearemos diferentes colores según su tipo: los agentes \textit{Polite} serán de color azul, los \textit{Aggressive} rojos y los \textit{Slow} verdes si están en modo evacuación yendo a la salida más cercana. Si tienen una salida favorita asignada, se usarán colores específicos para cada una. Por último, los obstáculos se representarán en gris oscuro. 
...
En la Figura \ref{fig:simulation_screenshots} se pueden ver capturas de pantalla del sistema de simulación final con ejemplos de lo mencionado. 
