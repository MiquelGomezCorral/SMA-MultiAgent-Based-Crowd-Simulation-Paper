...
Además, para hacer visibles los agentes, coloreamos de diferentes tonos de ciertos colores y formas según su tipo: los agentes \textit{Polite} serán rombos de color azul, los \textit{Aggressive} serán triángulos rojos y los \textit{Slow} círculos verdes. También, los obstáculos y las salidas serán cuadrados, los obstáculos se representarán en gris oscuro y las salidas cada una de un color. En las simulaciones en las que los agenges tengan una salida favorita, se usarán los colores de cada una en lugar de los colores por defecto.
