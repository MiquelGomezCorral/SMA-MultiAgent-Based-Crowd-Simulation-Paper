...
\begin{itemize}
    \item Ancho 1x: 142.3  steps, factor de bloqueo = 0.42, densidad local = 2.03
    \item Ancho 2x: 103.0 steps (+1.6\%), factor de bloqueo = 0.35, densidad local = 1.85
    \item Ancho 3x: 101.2 steps (+11.4\%), factor de bloqueo = 0.15, densidad local = 1.42
    \item Ancho 4x: 99.8 steps (+0.1\%), factor de bloqueo = 0.03, densidad local = 1.06
\end{itemize}
