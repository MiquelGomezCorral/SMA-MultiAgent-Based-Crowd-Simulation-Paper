...
\begin{itemize}
    \item \textbf{Re-planificación Cognitiva}: Implementar mapas de calor dinámicos (repulsión por densidad) para que los agentes eviten zonas congestionadas proactivamente.
    \item \textbf{Movimiento Continuo}: Añadir coordenadas continuas dentro de las celdas (sub-grid movement) para permitir adelantamientos y flujos más fluidos.
